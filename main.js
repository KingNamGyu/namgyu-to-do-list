  ...
  for (let i = 0; i < list.length; i++) {
    if (list[i].isComplete) {
      resultHTML += `<div class="task" id="${list[i].id}">
        <div class="div-flex">  
        <button class="check" onclick="toggleComplete('${list[i].id}')"><i class='fas fa-check-circle'></i></button>
      ...
      resultHTML += `<div class="task" id="${list[i].id}" >
      <div class="div-flex">  
      <button class="check" onclick="toggleComplete('${list[i].id}')"><i class='fas fa-check-circle' style='color: black;'></i></button>
